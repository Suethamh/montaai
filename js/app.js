  ...
  return ce('section', { className: 'cta-banner' },
    ce('div', { className: 'container' },
      ...
      ce('div', { className: 'cta-buttons' },
        ...
        ce('a', { href: 'https://wa.me/553497974002', target: '_blank', rel: 'noopener noreferrer', className: 'btn btn-whatsapp' },
          wppIcon(), ' WhatsApp'
        )
      )
    )
    ...
    ce('div', { className: 'container' },
      ...
      ce('div', { className: 'contact-grid' },
        ...
        ce('div', { className: 'contact-info fade-in' },
          ...
          ce('a', { href: 'https://wa.me/553497974002', target: '_blank', rel: 'noopener noreferrer', className: 'btn btn-whatsapp', style: { width: 'fit-content' } },
...
function WhatsAppFloat() {
  return ce('a', { href: 'https://wa.me/553497974002', target: '_blank', rel: 'noopener noreferrer', className: 'whatsapp-float', title: 'Fale conosco no WhatsApp' },
